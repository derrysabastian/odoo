...
from odoo.addons.wms_barcode.controllers.wms_barcode import StockBarcodeController
from odoo.addons.wms_barcode.tests.test_barcode_client_action import TestBarcodeClientAction
...
class TestPickingBarcodeClientAction(TestBarcodeClientAction):
    ...
    def test_picking_scan_package_confirmation(self):
        ...
        url = f'/odoo/{delivery_with_move.id}/action-wms_barcode.wms_barcode_picking_client_action'
    ...
    def test_delivery_source_location(self):
        ...
        url = '/odoo/action-wms_barcode.wms_barcode_action_main_menu'
    ...
    def test_pack_source_location(self):
        ...
        action_id = self.env.ref('wms_barcode.wms_barcode_action_main_menu')
    ...
    def test_scan_aggregate_barcode(self):
        """ Checks the config parameter `wms_barcode.barcode_separator_regex`
        ...
        self.env.user.write({'group_ids': [Command.link(self.env.ref('stock.group_production_lot').id)]})
        self.env['ir.config_parameter'].set_param('wms_barcode.barcode_separator_regex', '[,|]')
        url = "/odoo/action-wms_barcode.wms_barcode_action_main_menu"
    ...
    def test_split_line_on_exit_for_delivery_with_lot(self):
        ...
        action = self.env.ref('wms_barcode.wms_barcode_action_main_menu')
    ...
    def test_barcode_signature_flow(self):
        ...
        url = '/odoo/action-wms_barcode.stock_picking_type_action_kanban'
