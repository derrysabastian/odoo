...
class TestBarcodeClientAction(HttpCase):
    ...
    def setUpClass(cls):
        ...
        cls.env['ir.config_parameter'].set_param('wms_barcode.mute_sound_notifications', True)
    ...
    def _get_client_action_url(self, picking_id):
        return f'/odoo/{picking_id}/action-wms_barcode.wms_barcode_picking_client_action'
