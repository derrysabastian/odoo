...
class StockPackage(models.Model):
    ...
    def action_create_from_barcode(self, vals_list):
        ...
        return {
            'stock.package': res.read(self._get_fields_wms_barcode(), False)
        }
    ...
    def _get_usable_packages(self):
        ...
        records_limit = int(self.env['ir.config_parameter'].sudo().get_param('wms_barcode.usable_packages_limit', 3000))
