...
class StockLot(models.Model):
    ...
    def _get_wms_barcode_specific_data(self):
        ...
        return {
            'product.product': products.read(self.env['product.product']._get_fields_wms_barcode(), load=False),
            'uom.uom': products.uom_id.read(self.env['uom.uom']._get_fields_wms_barcode(), load=False)
        }
