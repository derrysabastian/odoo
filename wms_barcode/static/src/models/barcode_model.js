...
import LazyBarcodeCache from "@wms_barcode/lazy_barcode_cache";
...
export default class BarcodeModel extends EventBus {
    ...
    getActionRefresh(newId) {
        return {
            route: "/wms_barcode/get_barcode_data",
    ...
    _fieldToValue(fieldValue) {
        return fieldValue && typeof fieldValue === "object" ? fieldValue.id : fieldValue;
    }
                    ...
                    if (
                        ...
                        ((["boolean", "number", "string"].includes(typeof fieldValue) &&
                            ...
                            (typeof fieldValue === "object" &&
                                fieldValue &&
                                fieldValue.id !== (initialValue && initialValue.id)))
                    ) {
