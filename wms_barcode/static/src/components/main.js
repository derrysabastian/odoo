...
import GroupedLineComponent from "@wms_barcode/components/grouped_line";
...
class StockBarcodeUnlinkButton extends Component {
    static template = "wms_barcode.UnlinkButton";
...
registry.category("view_widgets").add("wms_barcode_unlink_button", {
    component: StockBarcodeUnlinkButton,
});

/**
 * TODO: wms_barcode should not depend on base_import.
 */
export class ImportBlockUI extends Component {
    ...
    static template = "wms_barcode.BlockUI";
}
...
class MainComponent extends Component {
    ...
    static template = "wms_barcode.MainComponent";
    static components = {
        BarcodeInput,
        BarcodeVideoScanner,
        Chatter,
    ...
    setup() {
        ...
        this.mobileService = this.env.services.mobile;
    ...
    async onWillStart() {
        const barcodeData = await rpc("/wms_barcode/get_barcode_data", {
            model: this.resModel,
            res_id: this.resId,
        });
        ...
        if (this.config.play_sound) {
            ...
            this.sounds = {
                ...
                success: new Audio(url(`/wms_barcode/static/src/audio/success.${fileExtension}`)),
            };
    ...
    setupCameraScanner() {
        ...
        this.barcodeVideoScannerProps = {
            ...
            cssClass: "o_wms_barcode_camera_video",
        };
    }
    ...
    _exit() {
        ...
        if (breadcrumbs.length === 1) {
            ...
            this.action.doAction("wms_barcode.wms_barcode_action_main_menu");
        } else {
...
registry.category("actions").add("wms_barcode_client_action", MainComponent);
