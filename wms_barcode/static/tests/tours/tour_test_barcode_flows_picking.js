import * as helper from "./tour_helper_wms_barcode";
...
registry.category("web_tour.tours").add("test_split_line_on_exit_for_delivery_with_lot", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan delivery_split_move_on_exit" },
        {
            trigger: ".o_barcode_client_action",
            run: () => {
                helper.assertLinesCount(1);
        ...
        { trigger: "button.o_exit", run: "click" },
        { trigger: ".o_wms_barcode_main_menu", run() {} },
    ],
});
...
registry
    ...
    .add("test_split_uncomplete_moves_on_exit_with_neutral_changes", {
        steps: () => [
            {
                trigger: ".o_wms_barcode_main_menu",
                run: "scan SUMOEWNC",
            },
            {
            ...
            { trigger: "button.o_exit", run: "click" },
            { trigger: ".o_wms_barcode_main_menu", run: "scan SUMOEWNC" },
            {
                trigger: ".o_barcode_line .o_toggle_sublines",
                run: "click",
            },
...
registry.category("web_tour.tours").add("test_internal_picking_from_scratch_with_package", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan WHINT" },
...
registry
    ...
    .add("test_internal_picking_reserved_move_packages_into_new_palet", {
        steps: () => [
            ...
            { trigger: ".o_wms_barcode_main_menu", run: "scan TEST/INT/0001" },
            {
                trigger: ".o_barcode_line",
                run: function () {
                    helper.assertLinesCount(2);
            ...
            { trigger: ".o_wms_barcode_main_menu", run: "scan TEST/INT/0002" },
            {
                trigger: ".o_barcode_line",
                run: function () {
                    helper.assertLinesCount(2);
...
registry.category("web_tour.tours").add("test_receipt_reserved_2_partial_put_in_pack", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan receipt_test" },
        {
            trigger: ".o_barcode_line",
            run: function () {
                helper.assertLinesCount(2);
...
registry.category("web_tour.tours").add("test_receipt_reserved_put_in_pack_after_interruption", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan TEST/IN/0001" },
        {
            trigger: ".o_barcode_line",
            run: function () {
                helper.assertLinesCount(4);
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan TEST/IN/0002" },
        { trigger: ".o_barcode_line", run: "scan product1" },
        {
...
registry.category("web_tour.tours").add("test_delivery_source_location", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan delivery_from_stock" },
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan delivery_from_second_stock" },
        // Tries to scan a location who doesn't belong to the delivery's source location.
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan WHOUT" },
        { trigger: ".o_barcode_client_action", run: "scan WH-SECOND-STOCK" },
        { trigger: ".o_scan_message.o_scan_product", run: "scan product1" },
...
registry.category("web_tour.tours").add("test_nomenclature_alias_and_conversion", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan WHIN" },
...
registry.category("web_tour.tours").add("test_receipt_duplicate_serial_number", {
    steps: () => [
        ...
        { trigger: '.o_wms_barcode_main_menu:contains("Scan or tap")', run: "click" },
        { trigger: ".o_wms_barcode_main_menu", run: "scan WHIN" },
...
registry.category("web_tour.tours").add("test_bypass_source_scan", {
    steps: () => [
        ...
        // Scan an unreserved serial stored in a sublocation: its line must be
        // sourced from that sublocation, not from the delivery's parent source location.
        {
            trigger: ".o_barcode_client_action",
            run: "scan sn_shelf",
        },
        {
            trigger: '.o_barcode_line:contains("sn_shelf")',
            run: function () {
                const line = helper.getLine({ selected: true });
                helper.assertLineProduct(line, "productserial1");
                helper.assertLineTrackingNumber(line, "sn_shelf");
                helper.assertLineSourceLocation(line, "WH/Stock/Section 3");
            },
        },
        ...stepUtils.validateBarcodeOperation(),
    ],
...
registry.category("web_tour.tours").add("test_delivery_put_in_pack_set_package_type", {
    steps: () => [
        { trigger: ".o_wms_barcode_main_menu", run: "scan TEST/OUT/PACK1" },
        { trigger: ".o_barcode_client_action", run: "scan product1" },
        { trigger: ".o_barcode_line.o_selected.o_line_completed" },
        ...
        { trigger: ".o_barcode_line .result-package" },
        ...stepUtils.validateBarcodeOperation(),
        { trigger: ".o_wms_barcode_main_menu", run: "scan TEST/OUT/PACK2" },
        { trigger: ".o_barcode_client_action", run: "scan product1" },
...
registry.category("web_tour.tours").add("test_put_packs_in_new_pack", {
    steps: () => [
        ...
        // DELIVERY PART
        { trigger: ".o_wms_barcode_main_menu", run: "scan WH/OUT/TEST/001" },
        // Scan first two lines' package.
        { trigger: ".o_barcode_line", run: "scan MNB-0000001" },
        {
            trigger: ".o_barcode_line:first-child.o_selected.o_line_completed",
...
registry.category("web_tour.tours").add("test_scrap", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan receipt_scrap_test" },
        {
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan delivery_scrap_test" },
...
registry.category("web_tour.tours").add("wms_barcode_package_with_lot", {
    steps: () => [
        {
            trigger: "[data-menu-xmlid='wms_barcode.wms_barcode_menu']", // open barcode app
            run: "click",
        },
        {
...
registry.category("web_tour.tours").add("test_setting_barcode_allow_extra_product", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan delivery_test" },
...
registry.category("web_tour.tours").add("test_scan_result_package_with_extra_product", {
    steps: () => [
        { trigger: ".o_wms_barcode_main_menu", run: "scan POOKPICK" },
        { trigger: ".o_barcode_client_action", run: "scan product2" },
...
registry.category("web_tour.tours").add("test_split_line_on_exit_for_delivery", {
    steps: () => [
        // Opens the delivery and checks its lines.
        { trigger: ".o_wms_barcode_main_menu", run: "scan delivery_split_line_on_exit" },
        {
            trigger: ".o_barcode_client_action",
            run: () => {
                helper.assertLinesCount(3);
...
registry.category("web_tour.tours").add("test_split_line_on_exit_for_receipt", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan receipt_split_line_on_exit" },
        {
            trigger: ".o_barcode_client_action",
            run: () => {
                helper.assertLinesCount(2);
...
registry.category("web_tour.tours").add("test_split_line_on_exit_for_receipt_with_grouped_lot", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan SPLOEFRWGL" },
        {
            trigger: ".o_barcode_client_action",
            run: () => {
                helper.assertLinesCount(1);
...
registry.category("web_tour.tours").add("test_multi_company_record_access_in_barcode", {
    steps: () => [
        { trigger: ".o_wms_barcode_main_menu", run: "scan company2_receipt" },
...
registry.category("web_tour.tours").add("test_no_zero_demand_new_line_from_split", {
    steps: () => [
        { trigger: ".o_wms_barcode_main_menu", run: "scan TNZDNLFS picking" },
        { trigger: ".o_edit", run: "click" },
...
registry.category("web_tour.tours").add("test_scan_product_when_in_form_view", {
    steps: () => [
        ...
        { trigger: ".o_wms_barcode_main_menu", run: "scan shelf3" },
...
registry.category("web_tour.tours").add("test_quant_selection_delivery_picking", {
    steps: () => [
         ...
         */
        {
            trigger: ".o_field_wms_barcode_quant_one2many .o_kanban_record:nth-child(3)",
            run: "click",
        },
        {
         ...
         */
        {
            trigger: ".o_field_wms_barcode_quant_one2many .o_kanban_record:nth-child(1)",
            run: "click",
        },
        {
...
registry.category("web_tour.tours").add("test_no_validate_no_dest_package", {
    steps: () => [
        ...
        {
            trigger: ".o_wms_barcode_list_kanban_view",
        },
    ],
});
...
registry.category("web_tour.tours").add("test_set_quantity_from_move_line_with_different_uom", {
    steps: () => [
        { trigger: ".o_wms_barcode_main_menu", run: "scan Test Receipt" },
        { trigger: ".o_edit", run: "click" },
        { trigger: "button.o_digipad_increment", run: "click" },
        { trigger: ".o_save", run: "click" },
        { trigger: ".o_barcode_line" },
...
registry.category("web_tour.tours").add("test_receipt_reserved_lot_putaway", {
    steps: () => [
        { trigger: ".o_barcode_client_action", run: "scan productlot1" },
        { trigger: ".o_barcode_line.o_selected", run: "scan lot1" },
        {
            trigger: '.o_barcode_line .o_line_lot_name:contains("lot1")',
            run: function () {
                helper.assertLinesCount(1);
                const line = helper.getLine({ barcode: "productlot1" });
                helper.assertLineQty(line, "1/2");
                helper.assertLineDestinationLocation(line, ".../Section 1");
            },
        },
        { trigger: ".o_barcode_client_action", run: "scan lot2" },
        {
            content: "Second lot should be part of the existing line.",
            trigger: '.o_barcode_line .o_barcode_scanner_qty:contains("2/2")',
            run: function () {
                helper.assertLinesCount(1);
                helper.assertLineQty(0, "2/2");
                helper.assertLineDestinationLocation(0, ".../Section 1");
        ...
        {
            trigger: ".o_barcode_line_details .o_line_lot_name:contains(lot2)",
            run: function () {
                helper.assertSublinesCount(2);
                const [lot1Line, lot2Line] = helper.getSublines();
                helper.assertLineTrackingNumber(lot1Line, "lot1");
                helper.assertLineTrackingNumber(lot2Line, "lot2");
            },
        },
        ...stepUtils.validateBarcodeOperation(),
    ],
